...
<body>
        ...
        <div>
            ...
            <div class="topheading1">
               ...
               <div class="topheading12">
                <a href="websitetest1.html" id="home">HOME</a>
                <a href="">PET SHOP</a>
               <div>
                <div class="dropdown">
   ...
   <div class="mid">
    <div class="mid1">
        <div ></div>
        <div class="mid2">
            <img class="dogimg" src="cute-small-puppy-line-icon-art-pet_444196-11217.avif" alt="">
            <p>DOG</p>
        </div>
        <div ></div>
        <div class="mid2">
            <img class="catimg" src="6fdfbc41d6a8e26d4b9073bc1afd899f.jpg" alt="">
            CAT</div>
        <div ></div>
        <div class="mid2">SERVICES</div>
        <div ></div>
        <div class="mid3">
    ...
    <div class="bottom">
        <img class="img" src="6570.jpg" alt="">
        <div class="boxes">
            <div>
